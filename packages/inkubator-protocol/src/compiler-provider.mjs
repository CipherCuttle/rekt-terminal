...
export const COMPILER_INTERPRETATION_SYSTEM_PROMPT = 'You are an untrusted interpretation adapter. Follow the requested JSON contract exactly and never claim source/human/deterministic authority.';
