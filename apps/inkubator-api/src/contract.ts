...
export const openapiDocument = {
  ...
  paths: {
    ...
    '/v1/players/{playerId}/block':{post:{operationId:'blockPlayer',security:[{sessionCookie:[]}],parameters:[{name:'playerId',in:'path',required:true,schema:ref('PlayerId')}],requestBody:{required:true,content:{'application/json':{schema:ref('SocialMutationRequest')}}},responses:{'200':{description:'Block social interaction',content:{'application/json':{schema:ref('PlayerBlockView')}}},'403':errorResponse('Self block denied'),'404':errorResponse('Player not found')}},delete:{operationId:'unblockPlayer',security:[{sessionCookie:[]}],parameters:[{name:'playerId',in:'path',required:true,schema:ref('PlayerId')}],requestBody:{required:true,content:{'application/json':{schema:ref('SocialMutationRequest')}}},responses:{'200':{description:'Remove block',content:{'application/json':{schema:ref('PlayerBlockView')}}}}}},
    '/v1/comments/{commentId}/report':{post:{operationId:'reportProjectComment',security:[{sessionCookie:[]}],parameters:[{name:'commentId',in:'path',required:true,schema:{type:'string',format:'uuid'}}],requestBody:{required:true,content:{'application/json':{schema:ref('ContentReportCreateRequest')}}},responses:{'201':{description:'Private moderation report receipt',content:{'application/json':{schema:ref('ContentReportView')}}},'404':errorResponse('Comment not found')}}},
    '/v1/projects/{projectId}/tester-requests':{post:{operationId:'createExternalTestRequest',security:[{sessionCookie:[]}],parameters:[{name:'projectId',in:'path',required:true,schema:ref('ProjectId')}],requestBody:{required:true,content:{'application/json':{schema:ref('ExternalTestRequestCreateRequest')}}},responses:{'201':{description:'Project owner requests external test',content:{'application/json':{schema:ref('ExternalTestRequestView')}}},'403':errorResponse('Project owner only'),'409':errorResponse('Open tester request already exists')}}},
    '/v1/tester-requests/{testRequestId}/results':{post:{operationId:'recordExternalTestResult',security:[{sessionCookie:[]}],parameters:[{name:'testRequestId',in:'path',required:true,schema:{type:'string',format:'uuid'}}],requestBody:{required:true,content:{'application/json':{schema:ref('ExternalTestResultCreateRequest')}}},responses:{'201':{description:'Bounded external human observation',content:{'application/json':{schema:ref('ExternalTestResultView')}}},'403':errorResponse('Owner/self/block denied'),'409':errorResponse('Tester request unavailable')}}},
    '/v1/projects/{projectId}/external-tests':{get:{operationId:'getProjectExternalTests',parameters:[{name:'projectId',in:'path',required:true,schema:ref('ProjectId')}],responses:{'200':{description:'Public bounded tester state',content:{'application/json':{schema:ref('ProjectExternalTestsView')}}},'404':errorResponse('Project not found')}}},
    '/v1/missions/{missionId}/ship-submissions': {post:{operationId:'submitShip',security:[{sessionCookie:[]}],parameters:[{name:'missionId',in:'path',required:true,schema:ref('MissionId')}],requestBody:{required:true,content:{'application/json':{schema:ref('ShipSubmissionCreateRequest')}}},responses:{'201':{description:'Claimed Ship submission queued for isolated verification',content:{'application/json':{schema:ref('ShipSubmissionView')}}},'400':errorResponse('Invalid Ship submission'),'401':errorResponse('Authentication required'),'403':errorResponse('Mission owner required'),'404':errorResponse('Mission not found'),'409':errorResponse('Ship submission conflict')}}},
